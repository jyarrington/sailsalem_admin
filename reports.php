...
class reports
{
  ...
  function classAttendence()
  {
    ...
    if ($_start_date == "") {
      ...
      foreach ($rs_sailing_sessions as $row) {
        ...
        <table border=1 cellpadding='3' cellspacing='0' class="attendance" style="font-size:10pt;">
          ...
          <?php
          foreach ($rs_students as $record) {

            echo "<tr>";

            $student_full_name = $record["first_name"] . " " . $record["last_name"];
            $guardian_one_full_name = $record["guardian_one_first_name"] . " " . $record["guardian_one_last_name"];
            $guardian_two_full_name = $record["guardian_two_first_name"] . " " . $record["guardian_two_last_name"];

            ?>

            <td class="student_full_name"><?php echo $student_full_name ?>&nbsp;</td>
            <td class="form_med">&nbsp;</td>
            <td class="form_swim">&nbsp;</td>
            <td class="parents"><?php echo $guardian_one_full_name . "<br />" . $guardian_two_full_name ?>&nbsp;</td>
            <td class="contact"><?php echo $record["phone1"] ?><br/>
              <?php echo $record["phone2"] ?><br/>
              <strong>(E) </strong><?php echo $record["emergency_phone"] ?>
            <td class="day"> &nbsp;</td>
            <td class="day"> &nbsp;</td>
            <td class="day"> &nbsp;</td>
            <td class="day"> &nbsp;</td>
